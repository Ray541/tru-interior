...
export default function Footer() {
  ...
  return (
    <footer className="w-full max-w-340 mx-auto px-3">
      <div className="w-full flex flex-wrap lg:flex-nowrap items-start justify-between gap-10 md:gap-5 py-7 px-3">
        <div className="flex-1 flex flex-col items-start gap-2 md:gap-3">
          ...
          <div className="w-full">
            <Link to="/" className="w-full" onClick={handleNameClick}>
      ...
      <h1 className="text-center text-3xl md:text-5xl lg:text-7xl xl:text-9xl font-black text-muted-foreground capitalize border-t border-b py-10">
        Tru Interiors
      </h1>
